...
class InPlaceMergeSortTest {
    InPlaceMergeSort<Integer> inPlaceMerge = new InPlaceMergeSort<>();
    ...
    void sortTest1() {
        ...
        this.inPlaceMerge.sort(arrayList, Comparator.naturalOrder());
    ...
    void sortTest2() {
        ...
        this.inPlaceMerge.sort(arrayList, Comparator.reverseOrder());
        Assertions.assertEquals(string, arrayList.toString());
    }

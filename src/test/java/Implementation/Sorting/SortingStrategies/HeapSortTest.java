...
import Main.Implementation.Sorting.SortingStrategies.HeapSort;
...
class HeapSortTest {
    ...
    void sortTest1() {
        ...
        this.HeapSort.set(arrayList, moves, Comparator.naturalOrder());
        this.HeapSort.run();
    ...
    void sortTest2() {
        ...
        this.HeapSort.set(arrayList, moves, Comparator.reverseOrder());
        this.HeapSort.run();
        Assertions.assertEquals(string, arrayList.toString());
    }

...
import Main.Implementation.Sorting.SortingStrategies.BitonicSort;
...
class BitonicSortTest {
    BitonicSort<Integer> BitonicSort = new BitonicSort<>();
    ...
    void sortTest1() {
        ...
        this.BitonicSort.set(arrayList, moves, Comparator.naturalOrder());
        this.BitonicSort.run();
    ...
    void sortTest2() {
        ...
        this.BitonicSort.set(arrayList, moves, Comparator.reverseOrder());
        this.BitonicSort.run();
        Assertions.assertEquals(string, arrayList.toString());
    }

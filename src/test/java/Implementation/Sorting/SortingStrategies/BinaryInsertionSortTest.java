...
import Main.Implementation.Sorting.SortingStrategies.BinaryInsertionSort;
...
class BinaryInsertionSortTest {
    ...
    void sortTest1() {
        ...
        this.BinaryInsertionSort.set(arrayList, moves, Comparator.naturalOrder());
        this.BinaryInsertionSort.run();
    ...
    void sortTest2() {
        ...
        this.BinaryInsertionSort.set(arrayList, moves, Comparator.reverseOrder());
        this.BinaryInsertionSort.run();

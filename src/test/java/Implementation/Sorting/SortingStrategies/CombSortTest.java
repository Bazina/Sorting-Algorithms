...
import Main.Implementation.Sorting.SortingStrategies.CombSort;
...
class CombSortTest {
    CombSort<Integer> CombSort = new CombSort<>();
    ...
    void sortTest1() {
        ...
        this.CombSort.set(arrayList, moves, Comparator.naturalOrder());
        this.CombSort.run();
    ...
    void sortTest2() {
        ...
        this.CombSort.set(arrayList, moves, Comparator.reverseOrder());
        this.CombSort.run();
        Assertions.assertEquals(string, arrayList.toString());
    }

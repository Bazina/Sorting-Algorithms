...
import Main.Implementation.Sorting.SortingStrategies.GnomeSort;
...
class GnomeSortTest {
    ...
    void sortTest1() {
        ...
        this.GnomeSort.set(arrayList, moves, Comparator.naturalOrder());
        this.GnomeSort.run();
    ...
    void sortTest2() {
        ...
        this.GnomeSort.set(arrayList, moves, Comparator.reverseOrder());
        this.GnomeSort.run();
        Assertions.assertEquals(string, arrayList.toString());
    }

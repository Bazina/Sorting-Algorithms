...
import Main.Implementation.Sorting.SortingStrategies.PancakeSort;
...
class PancakeSortTest {
    PancakeSort<Integer> PancakeSort = new PancakeSort<>();
    ...
    void sortTest1() {
        ...
        this.PancakeSort.set(arrayList, moves, Comparator.naturalOrder());
        this.PancakeSort.run();
    ...
    void sortTest2() {
        ...
        String string = "[8]";
         ...
         this.PancakeSort.set(arrayList, moves, Comparator.reverseOrder());
        this.PancakeSort.run();
        Assertions.assertEquals(string, arrayList.toString());
    }

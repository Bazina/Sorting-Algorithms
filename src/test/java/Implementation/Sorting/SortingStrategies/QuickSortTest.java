...
import Main.Implementation.Sorting.SortingStrategies.QuickSort;
...
class QuickSortTest {
    ...
    void sortTest1() {
        ...
        this.QuickSort.set(arrayList, moves, Comparator.reverseOrder());
        this.QuickSort.run();
    ...
    void sortTest4() {
        ...
        this.QuickSort.set(arrayList, moves, Comparator.naturalOrder());
        this.QuickSort.run();
        Assertions.assertEquals(string, arrayList.toString());
    }

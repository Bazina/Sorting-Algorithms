...
import Main.Implementation.Sorting.SortingStrategies.StoogeSort;
...
class StoogeSortTest {
    StoogeSort<Integer> StoogeSort = new StoogeSort<>();
    ...
    void sortTest1() {
        ...
        this.StoogeSort.set(arrayList, moves, Comparator.naturalOrder());
        this.StoogeSort.run();
    ...
    void sortTest2() {
        ...
        this.StoogeSort.set(arrayList, moves, Comparator.reverseOrder());
        this.StoogeSort.run();
        Assertions.assertEquals(string, arrayList.toString());
    }

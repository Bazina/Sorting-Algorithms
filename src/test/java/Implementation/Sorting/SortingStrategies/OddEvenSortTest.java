...
import Main.Implementation.Sorting.SortingStrategies.OddEvenSort;
...
class OddEvenSortTest {
    OddEvenSort<Integer> OddEvenSort = new OddEvenSort<>();
    ...
    void sortTest1() {
        ...
        this.OddEvenSort.set(arrayList, moves, Comparator.naturalOrder());
        this.OddEvenSort.run();
    ...
    void sortTest2() {
        ...
        this.OddEvenSort.set(arrayList, moves, Comparator.reverseOrder());
        this.OddEvenSort.run();
        Assertions.assertEquals(string, arrayList.toString());
    }
